...
#cgo linux,amd64 LDFLAGS: -L${SRCDIR}/lib/linux_amd64 -lopentui -Wl,-rpath,${SRCDIR}/lib/linux_amd64
#cgo linux,arm64 LDFLAGS: -L${SRCDIR}/lib/linux_arm64 -lopentui -Wl,-rpath,${SRCDIR}/lib/linux_arm64
